...
class Ui_CameraView(object):
    def setupUi(self, CameraView):
        ...
        self.verticalLayout_2.addWidget(self.frameLabel)
        ...
        self.video_speed = QtWidgets.QComboBox(CameraView)
        self.video_speed.setObjectName("video_speed")
        self.video_speed.addItem("")
        self.video_speed.addItem("")
        self.video_speed.addItem("")
        self.video_speed.addItem("")
        self.video_speed.addItem("")
        self.video_speed.addItem("")
        self.video_speed.addItem("")
        self.horizontalLayout_4.addWidget(self.video_speed)
        self.draw_polygon = QtWidgets.QPushButton(CameraView)
        self.draw_polygon.setObjectName("draw_polygon")
        self.horizontalLayout_4.addWidget(self.draw_polygon)
        self.line_2 = QtWidgets.QFrame(CameraView)
        ...
        self.vehicle_list = QtWidgets.QListWidget(CameraView)
        self.vehicle_list.setObjectName("vehicle_list")
        self.horizontalLayout_2.addWidget(self.vehicle_list)
        self.verticalLayout = QtWidgets.QVBoxLayout()
        self.verticalLayout.setObjectName("verticalLayout")
        self.vehicle_select = QtWidgets.QComboBox(CameraView)
        self.vehicle_select.setObjectName("vehicle_select")
        self.verticalLayout.addWidget(self.vehicle_select)
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.vehicle_up = QtWidgets.QRadioButton(CameraView)
        self.vehicle_up.setChecked(True)
        self.vehicle_up.setAutoExclusive(False)
        self.vehicle_up.setObjectName("vehicle_up")
        self.horizontalLayout.addWidget(self.vehicle_up)
        self.vehicle_down = QtWidgets.QRadioButton(CameraView)
        self.vehicle_down.setCheckable(True)
        self.vehicle_down.setChecked(False)
        self.vehicle_down.setAutoExclusive(False)
        self.vehicle_down.setObjectName("vehicle_down")
        self.horizontalLayout.addWidget(self.vehicle_down)
        self.verticalLayout.addLayout(self.horizontalLayout)
        self.add_vehicle = QtWidgets.QPushButton(CameraView)
        self.add_vehicle.setObjectName("add_vehicle")
        self.verticalLayout.addWidget(self.add_vehicle)
        spacerItem1 = QtWidgets.QSpacerItem(20, 17, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout.addItem(spacerItem1)
        self.remove_vehicle = QtWidgets.QPushButton(CameraView)
        self.remove_vehicle.setObjectName("remove_vehicle")
        self.verticalLayout.addWidget(self.remove_vehicle)
        self.save_and_quit = QtWidgets.QPushButton(CameraView)
        self.save_and_quit.setObjectName("save_and_quit")
        self.verticalLayout.addWidget(self.save_and_quit)
    ...
    def retranslateUi(self, CameraView):
        ...
        self.label.setText(_translate("CameraView", "Speed"))
        self.video_speed.setItemText(0, _translate("CameraView", "1"))
        self.video_speed.setItemText(1, _translate("CameraView", "2"))
        self.video_speed.setItemText(2, _translate("CameraView", "3"))
        self.video_speed.setItemText(3, _translate("CameraView", "4"))
        self.video_speed.setItemText(4, _translate("CameraView", "5"))
        self.video_speed.setItemText(5, _translate("CameraView", "10"))
        self.video_speed.setItemText(6, _translate("CameraView", "20"))
        self.draw_polygon.setText(_translate("CameraView", "Draw Polygon "))
        ...
        self.vehicle_up.setText(_translate("CameraView", "Up"))
        self.vehicle_down.setText(_translate("CameraView", "Down"))
        self.add_vehicle.setText(_translate("CameraView", "Add"))
        self.remove_vehicle.setText(_translate("CameraView", "Remove"))
        self.save_and_quit.setText(_translate("CameraView", "Save and Quit"))
